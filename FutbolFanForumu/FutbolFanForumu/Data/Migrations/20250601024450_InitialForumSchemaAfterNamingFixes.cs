...
namespace FutbolFanForumu.Data.Migrations
{
    /// <inheritdoc />
    public partial class InitialForumSchemaAfterNamingFixes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedForumThreadId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UpcomingMatches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UpcomingMatches_ForumThreads_RelatedForumThreadId",
                        column: x => x.RelatedForumThreadId,
                        principalTable: "ForumThreads",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UpcomingMatches_RelatedForumThreadId",
                table: "UpcomingMatches",
                column: "RelatedForumThreadId");
        }
